...
def _small_m_direct_supported(
    *,
    ...
    if os.environ.get("SPARKINFER_W4A16_SMALL_M_DIRECT", "1") == "0":
        return False
    activation = normalize_moe_activation(activation)
    swiglu_limit, swiglu_alpha, swiglu_beta = _normalize_activation_swiglu_params(
        activation,
...
@torch.library.custom_op(
    "sparkinfer::w4a16_small_m_direct_launch",
...
@torch.library.custom_op(
    "sparkinfer::w4a16_fused_moe_launch",
    mutates_args="unknown",
)
...
@torch.library.custom_op(
    "sparkinfer::w4a16_fused_moe_calibrated_launch",
    mutates_args="unknown",
)
...
@torch.library.custom_op(
    "sparkinfer::w4a16_topk_sum_launch",
    mutates_args=("output",),
)
...
@torch.library.custom_op(
    "sparkinfer::w4a16_fused_moe_hybrid_launch",
    mutates_args="unknown",
    device_types="cuda",
)
